...
<div style="width:300px;float:left;"><h3><?php echo !empty($title)?$title:'最新问题' ?></h3></div>
<div style="width:150px;float:left;">标签</div>
<div style="width:150px;float:left;">发布者</div>
<div style="width:160px;float:left;">发布时间</div>
</div>
...
<div style="width:300px;float:left;"><a href="/index.php?ac=detail&id=<?php echo $q['id']?>"><?php echo $q['title']?></a></div>
<div style="width:150px;float:left;"><?php echo $q['tag']?></div>
<div style="width:150px;float:left;" class='xt1'><?php echo $q['author']?></div>
<div style="width:160px;float:left;" class='xt1'><?php echo date('Y-m-d H:i:s',$q['create_time'])?></div>
</div>
<?php }}?>
